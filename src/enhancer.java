...
public class enhancer {
	public static void main(String[] args) {
		String input = FileScanner.readFromFile("lorem"); 					// Få inputtet fra readFromFile methoden
		...
		FileScanner.writeToFile(enhancedFinal,"lorem.rtf"); 					// skriv den enhancede version til en fil
	}
}
